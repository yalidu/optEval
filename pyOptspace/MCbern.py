...
mat=np.load('/data/yanxue/marleval/bernoulli10.npy')
...
def run_game():
    ...
    with open("/data/yanxue/marleval/picture_data/{}/{}/MC2P1fincon.pkl".format(alpha,game), "wb") as f:
    ...
    plt.savefig('/data/yanxue/marleval/picture_data/{}/{}/MC2P1fincon.pdf'.format(alpha,game))
    plt.show()

if __name__=='__main__':
    #run_game()

    with open("/data/yanxue/marleval/picture_data/{}/{}/MC2P1fincon.pkl".format(alpha,game), "rb") as f:
    ...
    plt.tight_layout()
    plt.savefig('/data/yanxue/marleval/picture_data/{}/final/perBer.pdf'.format(alpha,game))
    plt.show()
