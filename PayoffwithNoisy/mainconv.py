...
base_params = {
    ...
    "MC":[False],
    "MCr":[1],#rlist,#[init_r],
    "MCm":[1],#mlist,#[45,50,75,90]+[40,55,60,65,70,80,85]+[95]+[100,120,150,175,200],#[45,50,75,90,100,120,150,175,200],#[i for i in range(2000,6000+1,1000)]+[i for i in range(8000,32000+1,4000)],
...
print(direc)
date_str = "RGUCB{}".format(players)#"RGUCB"#"A"+str(datetime.date.today())
