...
base_params = {
    ...
    "MC":[False],
    "MCr":[1],
    "MCm":[1],#[45,50,75,90]+[40,55,60,65,70,80,85]+[95]+[100,120,150,175,200],#[45,50,75,90,100,120,150,175,200],#[i for i in range(2000,6000+1,1000)]+[i for i in range(8000,32000+1,4000)],
