...
base_params = {
    ...
    "MC":[False],
    "MCr":[1],
    "MCm":[1],#[2000,2500,3000,3500,4000,4500,5000,5500,6000,7000,8000,9000,9500],#[45,50,75,90]+[40,55,60,65,70,80,85]+[95]+[100,120,150,175,200],#[45,50,75,90,100,120,150,175,200],#[i for i in range(2000,6000+1,1000)]+[i for i in range(8000,32000+1,4000)],
...
print(direc)
date_str = "RGUCB"#"RGUCB"#"A"+str(datetime.date.today())
