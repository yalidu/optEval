...
base_params = {
    ...
    "MC":[True],
    "MCr":[init_r],
    "MCm":[2000,2500,3000,3500,4000,4500,5000,5500,6000,7000,8000,9000,9500],#[45,50,75,90]+[40,55,60,65,70,80,85]+[95]+[100,120,150,175,200],#[45,50,75,90,100,120,150,175,200],#[i for i in range(2000,6000+1,1000)]+[i for i in range(8000,32000+1,4000)],
    ...
    "t_max":[100*10*10],# [4000000],#[1000* 1000],  # Maximum timesteps to run for
...
env_dict["bernoulli"]=partial(game.Bernoulli_game,actions=100)#partial(game.Bernoulli_game)
...
direc = "/data/yanxue/marleval/picture_data/0.001/noisyber/{}".format(folder)
